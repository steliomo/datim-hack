...
public class CleanDataUseCaseTest {
	...
	public void shouldCleanData() {
		...
		final CleanDataCommand dataCommand = new CleanDataCommand("url", "stelio", "stelio", "teste.xlxs");
		Mockito.when(this.cleanDataPort.cleanData(ArgumentMatchers.anyString(), ArgumentMatchers.anyList())).thenReturn(10);
		...
		Mockito.verify(this.cleanDataPort, Mockito.times(1)).cleanData(ArgumentMatchers.anyString(), ArgumentMatchers.anyList());
